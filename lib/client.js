...
.skp-tag-project-disabled{color:var(--skp-warn);background:var(--skp-warn-soft);}
...
.skp-state-proj{color:var(--skp-warn);background:var(--skp-warn-soft);border-color:transparent;}
.skp-state-proj:hover:not(:disabled){background:color-mix(in srgb,var(--skp-warn) 18%,transparent);}
...
.skp-dot-project-disabled{background:var(--skp-warn);box-shadow:0 0 0 3px color-mix(in srgb,var(--skp-warn) 18%,transparent);}
...
`;
		...
		* （本项目状态没有意义，先启用全局配置再说）。
		*/
		function ProjectOverrideButton({ globalEnabled, projectDisabled, disabled, actionWord = "生效", onToggle }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
				...
				title: !globalEnabled ? "全局已禁用：先启用全局配置，本项目状态才有意义" : projectDisabled ? `点击恢复在本项目${actionWord}（全局配置不变）` : "点击在本项目禁用（仅本项目生效，全局配置不变）",
				onClick: onToggle,
				children: projectDisabled ? "项目已禁用" : "项目已启用"
			});
		}
		/**
		* 三域视图共用的"拉取 + 重拉"状态机。
		...
		function McpView({ api, workspace }) {
			...
			*/
			...
			const onToggleProjectDisabled = (server) => {
				runOp(api.overrides.toggle("mcp", server.key));
			};
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ScopeTabs, {
								value: tab,
								onChange: setTab
							}),
					...
					!loading && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("ul", {
									...
									children: [
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
											...
											children: [
												...
												server.enabled && server.disabledInProject === true && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
													className: "skp-tag skp-tag-project-disabled",
													children: "本项目禁用"
												})
											]
										}),
							...
							children: selectedServer ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(McpDetail, {
								...
								onToggleProject: selectedServer.scope === "global" && hasWorkspaceLabel(workspace) ? () => onToggleProjectDisabled(selectedServer) : void 0
							}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("h3", { children: server.key })
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								...
								title: isGlobal ? server.enabled ? "点击全局禁用（所有项目的 session 都不再挂载）" : "点击全局启用（恢复所有项目挂载）" : server.enabled ? "点击禁用（保留在配置文件中，不挂载）" : "点击启用（写入配置文件并挂载）",
								onClick: onToggle,
								children: isGlobal ? server.enabled ? "全局已启用" : "全局已禁用" : server.enabled ? "已启用" : "已禁用"
							}),
							onToggleProject !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ProjectOverrideButton, {
  ...
  "mcpServers": {
    ...
    "web": { "type": "http", "url": "http://localhost:3000/mcp" }
		...
		*/
		function QuickMessagesPanel({ api, workspace }) {
			...
			const onToggleProjectDisabled = (message) => {
				runOp(api.overrides.toggle("quickMessages", message.name));
			};
			/** 删除：第一次点击进入确认态；同一行再次点击才真正删除并清空选中。 */
					...
					!loading && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("ul", {
									...
									children: [
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
											...
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												...
												title: !message.enabled ? "已禁用" : message.disabledInProject === true ? "本项目禁用（全局仍启用）" : "已启用"
											}), message.name]
										}),
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
											className: "skp-row-meta",
											children: [
												...
												message.disabledInProject === true && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
													className: "skp-tag skp-tag-project-disabled",
													children: "本项目禁用"
												})
											]
							...
							children: selectedMessage ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(QuickMessageDetail, {
								...
								onToggleProject: selectedMessage.scope === "global" && hasWorkspaceLabel(workspace) ? () => onToggleProjectDisabled(selectedMessage) : void 0
							}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: "skp-detail-empty",
		...
		function QuickMessageDetail({ message, confirming, onEdit, onToggle, onDelete, projectDisabled, onToggleProject }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: "skp-detail-head",
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("h3", { children: message.name })
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "skp-detail-actions",
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								...
								title: isGlobal ? message.enabled ? "点击全局禁用（所有项目的快捷弹层都不再出现）" : "点击全局启用（恢复所有项目可用）" : message.enabled ? "点击禁用（保留在配置文件中，从快捷弹层隐藏）" : "点击启用（出现在输入框快捷弹层）",
								onClick: onToggle,
								children: isGlobal ? message.enabled ? "全局已启用" : "全局已禁用" : message.enabled ? "已启用" : "已禁用"
							}),
							onToggleProject !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ProjectOverrideButton, {
		...
		*/
								...
								children: [
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											...
											title: !isSkillEnabled(item) ? "已禁用（用户与模型都不可调用）" : item.disabledInProject === true ? "本项目禁用（全局仍启用）" : item.readOnly ? "只读条目" : "已启用（模型与用户均可调用）"
										}), item.name]
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
										className: "skp-row-meta",
										children: [
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												className: isProjectSource(item.source) ? "skp-tag skp-tag-project" : "skp-tag skp-tag-global",
												children: isProjectSource(item.source) ? "项目" : "全局"
											}),
											...
											item.disabledInProject === true && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												className: "skp-tag skp-tag-project-disabled",
												children: "本项目禁用"
											})
										]
		...
		function isGlobalSource(source) {
		...
		*/
		function SkillDetail({ summary, api, overrides, hasWorkspace, onChanged, onRemoved }) {
			const [busy, setBusy] = (0, react.useState)(false);
			const [opError, setOpError] = (0, react.useState)(void 0);
					...
					!summary.readOnly && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								...
								disabled: busy,
								title: isGlobal ? enabled ? "点击全局禁用（所有项目都不可调用）" : "点击全局启用（恢复所有项目可用）" : enabled ? "点击禁用（用户与模型都不可调用）" : "点击启用（恢复用户与模型调用）",
								onClick: () => void doSetEnabled(!enabled),
								children: isGlobal ? enabled ? "全局已启用" : "全局已禁用" : enabled ? "已启用" : "已禁用"
							}),
							hasWorkspace && isGlobal && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ProjectOverrideButton, {
		...
		*/
		function InstallDialog({ api, hasWorkspace, onClose, onInstalled }) {
			...
			const [scopeChoice, setScopeChoice] = (0, react.useState)(hasWorkspace ? "project-agents" : "global");
			const [overwrite, setOverwrite] = (0, react.useState)(false);
			const [busy, setBusy] = (0, react.useState)(false);
			const [errors, setErrors] = (0, react.useState)([]);
