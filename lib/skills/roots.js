...
/** skills 目录在各级根下的固定名称。 */
const PROJECT_DSH_SKILLS = "skills";
/**
 ...
 */
export function globalSkillsDir(dshHomeOverride) {
 ...
 * 环境变量，其次回退到 `~/.agents`
 */
export function userAgentsSkillsDir(agentsHomeOverride) {
 ...
 */
export function projectSkillsDir(cwd, target, projectRootOverride) {
